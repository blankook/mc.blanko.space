...
const ee = {
  ...
  , yp = {
    en: {
        ...
        hero: {
            subtitle: "Maximum power, minimum effort. Your path to victory starts here. Stable updates, clean visuals, smart tools, and reliable support give you a confident edge every day.",
            screenshots: "Screenshots"
        },
        sections: {
            screenshotsTitle: "Screenshots",
            screenshotsSubtitleLead: "Powerful",
            screenshotsSubtitleText: "functionality, stable performance, and well-designed tools for maximum advantage in game.",
            faqTitle: "FAQ",
            faqSubtitleLead: "Here are listed",
            faqSubtitleText: "our key advantages: stable performance, fast updates, convenient tools, and responsive support."
        },
        faq: {
            why: "Why us",
            whyText: "Stable updates, solid architecture, and clean UX without unnecessary noise.",
            advantages: "Advantages",
            advantagesText: "Fast launch, convenient tools, high compatibility, and regular improvements.",
            support: "Support",
            supportText: "Fast help, clear instructions, and continuous feedback on all questions.",
            rating: "Rating",
            ratingText: "Users note stability, quality, and practical value in real gameplay scenarios."
        },
        terms: {
            title: "Terms of Service",
            intro: "This public offer is published by the Seller on"
        },
        footer: {
            text: "Premium toolkit for Minecraft gameplay and daily use.",
    ...
    ru: {
        ...
        terms: {
            ...
            intro: "Публичная оферта опубликована продавцом на"
        },
        footer: {
            text: "Премиум тулкит для Minecraft и ежедневного использования.",
    ...
    uk: {
        ...
        hero: {
            subtitle: "Максимум сили, мінімум зусиль. Твій шлях до перемоги починається тут. Стабільні оновлення, зручні інструменти та надійна підтримка дають відчутну перевагу щодня.",
            screenshots: "Скріни"
        },
        sections: {
            screenshotsTitle: "Скріншоти",
            screenshotsSubtitleLead: "Потужний",
            screenshotsSubtitleText: "функціонал, стабільна робота та продумані інструменти для переваги в грі.",
            faqTitle: "FAQ",
            faqSubtitleLead: "Тут зібрані",
            faqSubtitleText: "наші ключові переваги: стабільність, швидкі оновлення, зручність і підтримка."
        },
        faq: {
            why: "Чому ми",
            whyText: "Стабільні оновлення, надійна архітектура та чистий UX без зайвого.",
            advantages: "Переваги",
            advantagesText: "Швидкий запуск, зручні інструменти, сумісність і регулярні покращення.",
            support: "Підтримка",
            supportText: "Швидка допомога, зрозумілі інструкції та постійний фідбек.",
            rating: "Оцінка",
            ratingText: "Користувачі відзначають стабільність, якість і практичну цінність."
        },
        terms: {
            title: "Умови користування",
            intro: "Публічна оферта опублікована продавцем на"
        },
        footer: {
            text: "Преміум тулкіт для Minecraft та щоденного використання.",
    ...
    pl: {
        ...
        hero: {
            subtitle: "Maksymalna moc, minimalny wysiłek. Twoja droga do zwycięstwa zaczyna się tutaj. Stabilne aktualizacje, wygodne narzędzia i pewne wsparcie dają realną przewagę każdego dnia.",
            screenshots: "Screeny"
        },
        sections: {
            screenshotsTitle: "Screeny",
            screenshotsSubtitleLead: "Mocna",
            screenshotsSubtitleText: "funkcjonalność, stabilna praca i dopracowane narzędzia dla przewagi w grze.",
            faqTitle: "FAQ",
            faqSubtitleLead: "Tutaj zebraliśmy",
            faqSubtitleText: "nasze główne zalety: stabilność, szybkie aktualizacje, wygodę i wsparcie."
        },
        faq: {
            why: "Dlaczego my",
            whyText: "Stabilne aktualizacje, solidna architektura i czysty UX bez chaosu.",
            advantages: "Zalety",
            advantagesText: "Szybki start, wygodne narzędzia, kompatybilność i regularne ulepszenia.",
            support: "Wsparcie",
            supportText: "Szybka pomoc, jasne instrukcje i stały feedback.",
            rating: "Ocena",
            ratingText: "Użytkownicy chwalą stabilność, jakość i praktyczną wartość."
        },
        terms: {
            title: "Warunki korzystania",
            intro: "Niniejsza oferta publiczna została opublikowana przez sprzedawcę na"
        },
        footer: {
            text: "Premium toolkit do Minecrafta i codziennego użycia.",
